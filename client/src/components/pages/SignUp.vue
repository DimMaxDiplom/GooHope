    ...
    <div class="sign_up_left">
      ...
      <div class="sign_up_left_fields" v-if="step === 2"> <!-- Второй шаг -->
        ...
        <Input label="Ваш Email" placeholder="Введите ваш email" type="email" @updateInput="on_update_input"
               field="email"
        />
        <Input label="Ваша страна" placeholder="Введите название вашей страны" type="text" @updateInput="on_update_input"
               field="country"
        />
      </div> <!-- Второй шаг -->
      <div class="sign_up_left_fields" v-if="step === 3"> <!-- Третий шаг -->
        <Input label="код" placeholder="Введите код, который пришёл к вам на почту" type="text" @updateInput="on_update_input"
               field="code"
        />
